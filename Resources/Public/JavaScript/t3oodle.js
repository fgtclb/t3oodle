...
window.onload = function() {
  ...
  // Init localstorage for
  if (localStorage) {
    var rememberInputs = document.querySelectorAll('*[data-remember]');
    for (var i = 0; i < rememberInputs.length; i++) {
      var rememberInput = rememberInputs[i];

...
- Create and edit polls (and its options) in frontend
    - Two types are available: **simple options** and **schedule** (date picker)
...
- ICS export (to import in e.g. Outlook) for schedule polls


- Poll author can choose a final option
